...
class ModelRegistry:
    ...
    @classmethod
    def get_runner_class(cls, model_name: str) -> type[BaseModelRunner] | None:
    ...
    @classmethod
    def cleanup(cls, model_name: str | None = None, gpu_id: int | None = None) -> None:
        if model_name and gpu_id is not None:
            ...
            for _key, runner in cls._instances.items():
                runner.cleanup()
